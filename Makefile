...
image:
	docker build --build-arg VERSION=$(VERSION) --build-arg BASE_TOMCAT_IMAGE=akshithachittanoori276/testt:US-620855-9-jdk11 -t $(IMAGE_NAME):US-6208551-9-jdk11 . # Build image and automatically tag it as latest on jdk17
...
# 	docker push $(IMAGE_NAME):$(VERSION)-jdk17
	docker push $(IMAGE_NAME):US-6208551-9-jdk11
